...
by MArtinix75 2025
version 0.6.3 piu argomenti generici (corezione bug untyped)
]#
...
macro connect*(widgetCall: typed; widgetSignal: untyped; callFunction: untyped) = #da untype a typed (bug su nin 2.2.x)
...
macro connect*[T](widgetCall: typed; widgetSignal: untyped; callFunction: untyped; functionArg: T) = #da untype a typed (bug su nin 2.2.x)
  let signalParameterTypes = getSignalParameterTypes()
  let signalStr = $widgetSignal
